"""
Database access for the Source System Service — Azure SQL (sqldb-sourcesystem),
Entra-only auth (no SQL logins). Implements REQ-COR-SRC-001.
...
SQL_DATABASE = os.environ.get("SQL_DATABASE", "sqldb-sourcesystem")
