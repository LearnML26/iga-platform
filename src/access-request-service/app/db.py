"""
Database access for the Access Request Service — Azure SQL (sqldb-accessrequest),
Entra-only auth (no SQL logins). Implements REQ-COR-REQ-001..003, 006, 007, 009.
...
SQL_DATABASE = os.environ.get("SQL_DATABASE", "sqldb-accessrequest")
