"""
Database access for the Rules Engine Service — Azure SQL (sqldb-rules),
Entra-only auth (no SQL logins). Implements REQ-COR-RULES-001..003, 006, 007.
...
SQL_DATABASE = os.environ.get("SQL_DATABASE", "sqldb-rules")
